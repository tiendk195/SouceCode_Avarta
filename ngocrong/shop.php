...
echo'<div class="phdr">Làng Ngọc Rồng > NPC > Cadic > Cửa hàng</div>';
...
<font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC"><b>Chào mừng chú đến SHOP của con! Hãy nhấp vào vật phẩm chú muốn mua nhé!</b></font></div>
<br><img src="https://i.imgur.com/nRnLcyT.gif"></center></td><td width="80%"><div class="pmenu"><div style="overflow: auto;height:140px">';

$vatpham=mysql_query("SELECT * FROM `ngocrong_cadicshop`  ORDER BY `id`");
