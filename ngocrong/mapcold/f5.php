...
echo'</br><font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC">
<b>Bạn đang sử dụng Cải trang Frost 2, Sức mạnh + 50%</b></font>';

}
	if ($datauser['matna']==257 ){

echo'</br><font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC">
<b>Bạn đang sử dụng Cải trang Frost 3, Sức mạnh + 60%</b></font>';
...
';
 		...
 		if ($datauser['matna']!=258 or $datauser['matna']!=256 or $datauser['matna']!=257  ){

echo'</br><font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC">
<b>Do ảnh hưởng bởi cái lạnh, bạn bị trừ 10% Sức mạnh</b></font>
';
}
   echo'
