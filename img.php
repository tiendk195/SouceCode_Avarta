...
$canh=ImageWorkshop::initFromPath($rootpath.'images/nensau-ok/'.mysql_result($avatar,0,'nensau').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/nensau-ok/load/'.mysql_result($avatar,0,'nensau').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/nensau-ok/load/'.mysql_result($avatar,0,'nensau').'.png');
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/canh-ok/'.mysql_result($avatar,0,'canh').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/canh-ok/load/'.mysql_result($avatar,0,'canh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/canh-ok/load/'.mysql_result($avatar,0,'canh').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/haoquang-ok/'.mysql_result($avatar,0,'haoquang').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/haoquang-ok/load/'.mysql_result($avatar,0,'haoquang').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/haoquang-ok/load/'.mysql_result($avatar,0,'haoquang').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok/'.mysql_result($avatar,0,'quan').'.png'); // kiem tra gioi tinh
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/quan-ok/load/'.mysql_result($avatar,0,'quan').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok/load/'.mysql_result($avatar,0,'quan').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
} else { // neu ko co quan ao thi dung mac dinh
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 0, "LB");}

// them ao
if(mysql_result($avatar,0,'ao')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok/'.mysql_result($avatar,0,'ao').'.png'); // kiem tra gioi tinh
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/ao-ok/load/'.mysql_result($avatar,0,'ao').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok/load/'.mysql_result($avatar,0,'ao').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else { // neu ko co quan ao thi dung mac dinh
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
// khuôn mặt
if(mysql_result($avatar,0,'khuonmat')){ // khuonmat
$canh=ImageWorkshop::initFromPath($rootpath.'images/khuonmat-ok/'.mysql_result($avatar,0,'khuonmat').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/khuonmat-ok/load/'.mysql_result($avatar,0,'khuonmat').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/khuonmat-ok/load/'.mysql_result($avatar,0,'khuonmat').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else {
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok/'.mysql_result($avatar,0,'mat').'.png'); // kiem tra gioi tinh
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/mat-ok/load/'.mysql_result($avatar,0,'mat').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok/load/'.mysql_result($avatar,0,'mat').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
} else { // neu ko co quan ao thi dung mac dinh
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 0, "LB");}

if(mysql_result($avatar,0,'toc')){ // them toc
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok/'.mysql_result($avatar,0,'toc').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/toc-ok/load/'.mysql_result($avatar,0,'toc').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok/load/'.mysql_result($avatar,0,'toc').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else {if($avatar2['sex'] == 'm'){
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}else{
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok/nu-0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/kinh-ok/'.mysql_result($avatar,0,'kinh').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/kinh-ok/load/'.mysql_result($avatar,0,'kinh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/kinh-ok/load/'.mysql_result($avatar,0,'kinh').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok/'.mysql_result($avatar,0,'matna').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/matna-ok/load/'.mysql_result($avatar,0,'matna').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok/load/'.mysql_result($avatar,0,'matna').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
// thêm cần câu
if(mysql_result($avatar,0,'cancau')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/cancau-ok/'.mysql_result($avatar,0,'cancau').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/cancau-ok/'.mysql_result($avatar,0,'cancau').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/cancau-ok/'.mysql_result($avatar,0,'cancau').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/non-ok/'.mysql_result($avatar,0,'non').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/non-ok/load/'.mysql_result($avatar,0,'non').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/non-ok/load/'.mysql_result($avatar,0,'non').'.png');
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok/'.mysql_result($avatar,0,'docamtay').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/docamtay-ok/load/'.mysql_result($avatar,0,'docamtay').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok/load/'.mysql_result($avatar,0,'docamtay').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/thucung-ok/'.mysql_result($avatar,0,'thucung').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/thucung-ok/load/'.mysql_result($avatar,0,'thucung').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/thucung-ok/load/'.mysql_result($avatar,0,'thucung').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
