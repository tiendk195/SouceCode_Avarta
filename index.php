...
{
switch ($_GET['lang'])
case 'en': $_SESSION['lang'] = 'en';
case 'fr': $_SESSION['lang'] = 'fr';
default: $_SESSION['lang'] = 'vi';
}
...
echo'<div class="phdr">Lỗi đường dẫn</div>';
echo'<div class="menu"><b>Địa chỉ không khả dụng hoặc đã bị xóa nhấn vào đây để về <br><a href="/"><font color="red">Trang chủ</font></a></b></div>';
...
//include 'chemgio.php';
 ...
 mysql_query("UPDATE `users` SET `khuvuc`='home' WHERE `id`='{$user_id}'");
