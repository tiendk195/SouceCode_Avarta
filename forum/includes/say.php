...
$ten = $ten2['text'];
$text = '<b><font color="003366">'.$us.'</font></b><font color="000000"> Vừa bình luận  <img src="/images/quotes.png" height="20px"></img> bài viết của bạn tại chủ đề </font><a href="/forum/'.$id.'.html"><font color="003366">'.$type1['text'].'</font></a>';
    ...
    case 'm':
        ...
        if (!empty($_POST['citata'])) {
            ...
            $citata = isset($_POST['citata']) ? htmlspecialchars($_POST['citata']) : '';
...
//////////////////
            ...
            echo'<div class="phdrbox">';
            $qt = str_replace("<br/>", "\r\n", $qt);
            $qt = htmlspecialchars(preg_replace('#\[c\](.*?)\[/c\]#si', '', $qt));
...
echo'<div class="news">Bạn chưa kích hoạt tài khoản nên không thể trích dẫn bài viết</div>';
}
        }
        echo'</div>';
        break;
