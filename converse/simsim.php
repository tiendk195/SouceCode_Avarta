...
$curl = curl_init();
         $headers = array(
           ...
           'Referer: http://cuibapv2.tk',
           'User-Agent: Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.6; pl; rv:1.9.2.13) Gecko/20101203 Firefox/3.5.13',
           'X-Requested-With: XMLHttpRequest'
         );
         curl_setopt($curl, CURLOPT_URL, 'http://cuibapv2.tk/converse/api.php?key=pkoolvn&text='.$pt.'');
...
$traloi = "Bé Tâm iu ck Tiền nhứt nhứt lun í";
}
...
$traloi = "dạ em nghe nà";
}
if($msg == "ngủ"){
$traloi = "dạ a ngủ ngoan nha <3";
}
if($msg == "off" || $msg == "of"){
