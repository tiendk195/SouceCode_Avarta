...
echo '<div class="menu"><form action="botpanel.php?act=say" method="post">Từ khóa<span class="red">*</span>:<br><input type="text" name="key"><br>Trả lời<span class="red">*</span>:<br><input type="text" name="text"><br>Trả lời 1<br><input type="text" name="txt1"><br>Trả lời 2<br><input type="text" name="txt2"><br>Trả lời 3<br><input type="text" name="txt3"><br>Trả lời 4<br><input type="text" name="txt4"><br>Trả lời 5<br><input type="text" name="txt5"><br><input type="submit" value="Thêm"></form></div>';
echo '<div class="menu"><span class="red">*</span>: điền vào trường bắt buộc.<br><b>{user}</b> hiển thị tên nick người dùng.<br><b>{text}</b> dán lại đoạn text vừa
gửi đi của thành viên<br><b>{reply}</b> trích dẫn</div>';
...
++$i;
        ...
        if ($total > $kmess) {
            echo '<p>' . functions::display_pagination('botpanel.php?page=', $start, $total, $kmess) . '</p>';
...
echo '<div class="gmenu"><form action="botpanel.php?act=edit&&id='.$id.'&&ok=1" method="post">Từ khóa<br><input type="text" name="key" value="'.$edit['key'].'"><br>Trả lời<br><input type="text" name="text" value="'.$edit['text'].'"><br>Trả lời 1<br><input type="text" name="etxt1" value="'.$edit['txt1'].'"><br>Trả lời 2<br><input type="text" name="etxt2" value="'.$edit['txt2'].'"><br>Trả lời 3<br><input type="text" name="etxt3" value="'.$edit['txt3'].'"><br>Trả lời 4<br><input type="text" name="etxt4" value="'.$edit['txt4'].'"><br>Trả lời 5<br><input type="text" name="etxt5" value="'.$edit['txt5'].'"><br><input type="submit" value="Sửa"></form>';
}
break;
}
} else {
