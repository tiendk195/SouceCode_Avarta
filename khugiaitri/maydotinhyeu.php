...
echo'<div class="phdr">Máy Đo Tình Yêu Online</div>';
echo'<div class=""><img src=/icon/maydotinhyeu.gif></div>';
echo'<div class=""><b>Nhập Tên Của 2 Người Muốn Đo Tình Yêu </b></div>';
