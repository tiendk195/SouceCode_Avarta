...
echo'<div class="phdr">Quay số > Quay số miễn phí</div>';
switch($act) {
default:
...
$vatpham = mysql_query("SELECT * FROM `quayso` WHERE `id`!=0 ORDER BY `id` ");
