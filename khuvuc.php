...
if(file_exists($rootpath.'images/canh-ok/'.mysql_result($avatar,0,'canh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/canh-ok/'.mysql_result($avatar,0,'canh').'.png');
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/haoquang-ok/'.mysql_result($avatar,0,'haoquang').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/haoquang-ok/'.mysql_result($avatar,0,'haoquang').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/quan-ok/'.mysql_result($avatar,0,'quan').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok/'.mysql_result($avatar,0,'quan').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/ao-ok/'.mysql_result($avatar,0,'ao').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok/'.mysql_result($avatar,0,'ao').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else { // neu ko co quan ao thi dung mac dinh
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok/'.mysql_result($avatar,0,'mat').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/mat-ok/0.png')){
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/toc-ok/'.mysql_result($avatar,0,'toc').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok/'.mysql_result($avatar,0,'toc').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/kinh-ok/'.mysql_result($avatar,0,'kinh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/kinh-ok/'.mysql_result($avatar,0,'kinh').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/matna-ok/'.mysql_result($avatar,0,'matna').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok/'.mysql_result($avatar,0,'matna').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/non-ok/'.mysql_result($avatar,0,'non').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/non-ok/'.mysql_result($avatar,0,'non').'.png');
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/docamtay-ok/'.mysql_result($avatar,0,'docamtay').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok/'.mysql_result($avatar,0,'docamtay').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/thucung-ok/'.mysql_result($avatar,0,'thucung').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/thucung-ok/'.mysql_result($avatar,0,'thucung').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
