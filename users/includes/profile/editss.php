...
if (isset($_GET['delavatar'])) {
 ...
 $user['luongkhoa'] = isset($_POST['luongkhoa_']) ? functions::check(mb_substr(htmlspecialchars($_POST['luongkhoa_']), 0, 50)): ''; 
   
$user['xu'] = isset($_POST['xu']) ? functions::check(mb_substr(htmlspecialchars($_POST['xu']), 0, 50)): ''; 
$user['luong'] = isset($_POST['luong']) ? functions::check(mb_substr(htmlspecialchars($_POST['luong']), 0, 50)): ''; 
  if($user['rights'] > $rights || $user['rights'] > 10 || $user['rights'] < 0)
        $user['rights'] = 0;
...
/*
		...
		*/
		echo'
<tr>
<td class="left-info">Chữ Ký: </td>
             <td class="right-info"><span><input type="text" value="' . $user['chuky'] . '" name="chuky" /></span></td>
        </tr>


<tr>                                
<td class="left-info">Xu: </td>
             <td class="right-info"><span><input type="text" value="' . $user['xu'] . '" name="xu" /></span></td>
        </tr>
<tr>
<td class="left-info">Lượng: </td>
             <td class="right-info"><span><input type="text" value="' . $user['luong'] . '" name="luong" /></span></td>
        </tr>';
		if ($datauser['rights']>=9) {
echo'<tr>
<td class="left-info">Lượng khóa: </td>
             <td class="right-info"><span><input type="text" value="' . $user['luongkhoa'] . '" name="luongkhoa_" /></span></td>
        </tr>';
		}
		echo'
<tr>
