...
switch ($mod) {
    case 'do':
        ...
        -----------------------------------------------------------------
        */
        if ($rights < 1 || ($rights < 3 && $user['rights']) || ($rights <= $user['rights'])) {
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($rights == 1 && $term != 14 || $rights == 3 && $term != 11 || $rights == 4 && $term != 16 || $rights == 5 && $term != 15)
                ...
                if ($datauser['rights'] < 2 && $timeval > 86400)
                    $timeval = 86400;
                if ($datauser['rights'] < 6 && $timeval > 2592000)
                    $timeval = 2592000;
                
                    // Hoang Anh
					mysql_query("UPDATE `users` SET `timeban`='" . (time() + $timeval) ."' WHERE `id` = '" .$id."'");
        ...
        */
        if ($rights >= 9) {
            ...
            if (isset($_POST['submit'])) {
				...
				mysql_query("UPDATE `users` SET `timeban`=0 WHERE `id`='" .$user['id']."'");
        ...
        if ($total) {
            ...
            while ($res = mysql_fetch_assoc($req)) {
                ...
                echo '<div class="menu">▶&#160;' .
                     ...
                     '<br /><span class="forumtext"><b>Lý do khóa:</b></span> ' . functions::checkout($res['ban_reason']);
                if ($rights > 0)
