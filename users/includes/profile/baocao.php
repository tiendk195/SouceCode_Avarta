...
// Project site:          http://tuoitre4u.com                                //
// Support site:          http://tuoitre4u.com                                //
////////////////////////////////////////////////////////////////////////////////
// Lead Developer:        Oleg Kasyanov   (AlkatraZ)  hotro.hoanganh@gmail.com//
// Development Team:      Eugene Ryabinin (john77)    hotro.hoanganh@gmail.com//
//                        Dmitry Liseenko (FlySelf)   hotro.hoanganh@gmail.com//
////////////////////////////////////////////////////////////////////////////////
*/
...
if(isset($_POST['submit'])){
	...
	$msg1 = 'Nguoi bi vi pham <a href="profile.php?user=' . $xuly['id'] . '">' . $xuly['name'] . '</a> ly do ' . $msg . '';
			...
			echo '<div class="menu">Cảm ơn bạn đã gửi "Báo cáo vi phạm" của thành viên đến <b>BQT</b> chúng tôi sẽ xử lý thành viên vi phạm "Nội quy" diễn đàn ngay lập tức. Chúc bạn vui vẻ';
		}else{
echo '<div class="phdr"><b>Gửi báo cáo vi phạm</b></div>';
...
echo '<div class="omenu">' .
                     ...
                     '</div>' .
                     '<form name="form" action="profile.php?act=baocao&amp;user=' . $user['id'] . '" method="post">' .
                     '<div class="menu">' .
