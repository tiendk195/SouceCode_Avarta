<?php
$check_ao = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'ao'"));
$ducnghia_ao = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_ao['id_ruong']."' "));
...
//
$check_quan = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'quan'"));
$ducnghia_quan = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_quan['id_ruong']."' "));
...
//
$check_canh = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'canh'"));
$ducnghia_canh = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_canh['id_ruong']."' "));
...
//
$check_docamtay = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'docamtay'"));
$ducnghia_docamtay = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_docamtay['id_ruong']."' "));
...
//
$check_thucung = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'thucung'"));
$ducnghia_thucung = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_thucung['id_ruong']."' "));
...
//
$check_haoquang = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'haoquang'"));
$ducnghia_haoquang = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_haoquang['id_ruong']."' "));
...
//
$check_matna = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'matna'"));
$ducnghia_matna = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_matna['id_ruong']."' "));
...
//
$check_kinh = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'kinh'"));
$ducnghia_kinh = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_kinh['id_ruong']."' "));
...
//
$check_khuonmat = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'khuonmat'"));
$ducnghia_khuonmat = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_khuonmat['id_ruong']."' "));
...
//
$check_toc = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'toc'"));
$ducnghia_toc = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_toc['id_ruong']."' "));
...
//
$check_mat = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'mat'"));
$ducnghia_mat = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_mat['id_ruong']."' "));
...
$check_non = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'non'"));
$ducnghia_non = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_non['id_ruong']."' "));
...
$check_cancau = mysql_fetch_array(mysql_query("SELECT * FROM `dangmac` WHERE `user_id`='{$user['id']}' AND `loai` = 'cancau'"));
$ducnghia_cancau = mysql_fetch_array(mysql_query("SELECT * FROM `khodo` WHERE `user_id`='{$user['id']}'  AND `id` = '".$check_cancau['id_ruong']."' "));
