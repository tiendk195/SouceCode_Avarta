...
echo'<div class="pmenu"><div style="overflow:auto;height:150px"><div class="gd_con"><font color="green"> <font size="1">'.$info2['tenvatpham'].'</font> ';
if ($info[sao]>0){
   echo' <font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC"><b>[ '.$info[sao ].' ✩ ]</b></font>';
}
echo'</font></div>';

if ($info[sucmanh]>0){
   echo' <div class="gd_con"><font size="1">Sức mạnh: <font color="red"><font color="blue"> '.number_format($info[sucmanh]).' [ +'.$info[cong ].' ] </font> </font></font></div>';
}
if ($info[hp]>0){
   echo' <div class="gd_con"><font size="1">HP: <font color="red"><font color="blue"> '.number_format($info[hp]).' [ +'.$info[conghp ].' ] </font> </font></font></div>';
}
echo'
