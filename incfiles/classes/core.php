...
$core = '<a href="http://vncity.tk">Tham gia cộng đồng giải trí VNCity.Tk</a>';
class core
{
    public static $root = '../';
    ...
    */
    ...
    {
        require(self::$root . 'incfiles/Config_bylt_2020/@@config@@@.php');
        ...
        $connect = @mysql_connect($db_host, $db_user, $db_pass) or die('<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
<html"><head title="Bảo Trì"><title>Bảo Trì</title>	
<meta charset="UTF-8">
<meta http-equiv=”Content-Type” content=”text/html; charset=UTF-8″/><center><img src="https://i.imgur.com/jG9Ntgw.jpg" width ="200" heith ="200" ></center>
<div style="text-align: center">
<h2 style="color:red">Bảo trì!</h2> Hệ thống tạm ngưng bảo trì! <br></body></html>');
        @mysql_select_db($db_name) or die('Lỗi Tình Trạng Dữ Liệu');
