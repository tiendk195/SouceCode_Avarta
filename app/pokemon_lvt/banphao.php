...
echo'<div class="phdr"> Sự kiện Pokemon &gt; <a href="index.php"> Quay về</a></div>';
...
echo'<form method="post"><div class="omenu"><center>1 lần bắn <font color="blue">Pháo hoa vui vẻ </font> = <font color="red">5 Lượng</font><br>
