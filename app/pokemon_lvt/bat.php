...
mysql_query("UPDATE `users` SET `diempokemon` =`diempokemon`+  '".$diem."' WHERE `id`= '".$user_id."'");
...
';
echo'</br></br><input type="submit" id="btn-bat" name="bat" value="Bắt"></form></center></div>';
...
//echo'</br></br><button name="bat"> Bắt ngay </button></form></center>';
