...
echo'<div class="phdr"><center>Sử dụng Hộp quà sinh nhật</center></div>';
echo'
<div class="omenu"> <center>
<font color="red">Bạn đang có: '.$hopqua['soluong'].' <img src="/images/vatpham/164.png"> </font>
<br><form method="post"><input id="submit" type="submit" name="submit" value="Sử dụng"></form></center><div id="load"></div></div>';
