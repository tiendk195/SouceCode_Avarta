...
//Keet thuc topic
mysql_query("UPDATE `users` SET `vitri`='673' WHERE `id`='{$user_id}'");
//-- Online Topic ---//
$online_u = mysql_result(mysql_query("SELECT COUNT(*) FROM `users` WHERE `lastdate` > " . (time() - 300) . " AND `vitri` = '673'"), 0);
$totalonline = $online_u;
$q = @mysql_query("select * from `users` where `lastdate` > " . (time() - 300) . " AND `vitri` = '673';");
...
<script type="text/javascript">
$(document).ready(function(){
	$('#nhanthuong').click(function(){
		var url = "cua6-load.php";
		var data = {"nhanthuong": ""};
		$('#load').load(url, data);
		return false;
	});
...
echo'<img src="https://i.imgur.com/XxlSmvc.png" style="position:absolute;margin: -14px 0 0 237px;">';
echo'<img src="https://i.imgur.com/XxlSmvc.png" style="position:absolute;margin: -14px 0 0 55px;" class="xavt">';

    echo'<img src="https://i.imgur.com/jV67HVc.png" style="position:absolute;margin: 258px 0 0 -150px;" ><img src="https://i.imgur.com/jV67HVc.png" style="position:absolute;margin: 258px 0 0 312px;" class="xavt" >
    <img src="https://i.imgur.com/8aG70Cz.png" style="position:absolute;margin: 203px 0 0 0px;" ><img src="https://i.imgur.com/8aG70Cz.png" style="position:absolute;margin: 203px 0 0 243px;" >';
   echo'<a href="cua'.$rand.'.php"><img src="/images/vao.gif" style="position:absolute;margin: 295px 0 0 136px;"></a>';
...
';
echo'<img src="https://i.imgur.com/tKQQn5q.gif" style="position:absolute;margin: -95px 0 0 238px;"></br><center><div class="omenu">Cảm ơn '.$login.' đã vào tận đây để tìm ta. Ta có phần thưởng cho ngươi đây:</div><form method="post"><input type="submit" id="nhanthuong" name="nhanthuong" value="Nhận thưởng"></form></center>';
    echo '<div id="content-load">';
