...
if ($total) {
    ...
    for ($i = 0; $row = mysql_fetch_assoc($req); ++$i) {
        ...
        $arg = array(
            ...
            'sub'    => '<p><small><a href="mail.php?id=' . $row['id'] . '"><font color="003366">Tin nhắn</font></a> | <a href="index.php?act=ignor&amp;id=' . $row['id'] . '&amp;add"><font color="003366">Bỏ qua</font></a> | <a href="index.php?act=deluser&amp;id=' . $row['id'] . '"><font color="003366">Xóa</font></a></small></p>',
            'iphide' => 1
        );
