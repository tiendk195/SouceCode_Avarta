...
//Nền sau
if(mysql_result($avatar,0,'nensau')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/nensau-ok-lt/'.mysql_result($avatar,0,'nensau').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/nensau-ok-lt/load/'.mysql_result($avatar,0,'nensau').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/nensau-ok-lt/load/'.mysql_result($avatar,0,'nensau').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
}
// thêm hào quang
if(mysql_result($avatar,0,'haoquang')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/haoquang-ok-lt/'.mysql_result($avatar,0,'haoquang').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/haoquang-ok-lt/load/'.mysql_result($avatar,0,'haoquang').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/haoquang-ok-lt/load/'.mysql_result($avatar,0,'haoquang').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
}
// them canh
if(mysql_result($avatar,0,'canh')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/canh-ok-lt/'.mysql_result($avatar,0,'canh').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/canh-ok-lt/load/'.mysql_result($avatar,0,'canh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/canh-ok-lt/load/'.mysql_result($avatar,0,'canh').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok-lt/'.mysql_result($avatar,0,'quan').'.png'); // kiem tra gioi tinh
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/quan-ok-lt/load/'.mysql_result($avatar,0,'quan').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok-lt/load/'.mysql_result($avatar,0,'quan').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LB");
} else { // neu ko co quan ao thi dung mac dinh
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok-lt/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 0, "LB");}

// them ao
if(mysql_result($avatar,0,'ao')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok-lt/'.mysql_result($avatar,0,'ao').'.png'); // kiem tra gioi tinh
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/ao-ok-lt/load/'.mysql_result($avatar,0,'ao').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok-lt/load/'.mysql_result($avatar,0,'ao').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else { // neu ko co quan ao thi dung mac dinh
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok-lt/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
// khuôn mặt
if(mysql_result($avatar,0,'khuonmat')){ // khuonmat
$canh=ImageWorkshop::initFromPath($rootpath.'images/khuonmat-ok-lt/'.mysql_result($avatar,0,'khuonmat').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/khuonmat-ok-lt/load/'.mysql_result($avatar,0,'khuonmat').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/khuonmat-ok-lt/load/'.mysql_result($avatar,0,'khuonmat').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else {
$canh=ImageWorkshop::initFromPath($rootpath.'images/khuonmat-ok-lt/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");}

// thêm tâm trạng
if(mysql_result($avatar,0,'mat')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok-lt/'.mysql_result($avatar,0,'mat').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/mat-ok-lt/load/0.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok-lt/load/0.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}else {
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok-lt/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$canh=ImageWorkshop::initFromPath($rootpath.'images/mat-ok-lt/load/0.png');
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok-lt/'.mysql_result($avatar,0,'toc').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/toc-ok-lt/load/'.mysql_result($avatar,0,'toc').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok-lt/load/'.mysql_result($avatar,0,'toc').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
} else {if($avatar2['sex'] == 'm'){
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok-lt/0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}else{
$canh=ImageWorkshop::initFromPath($rootpath.'images/toc-ok-lt/nu-0.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/kinh-ok-lt/'.mysql_result($avatar,0,'kinh').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/kinh-ok-lt/load/'.mysql_result($avatar,0,'kinh').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/kinh-ok-lt/load/'.mysql_result($avatar,0,'kinh').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
if($avatar2['zombie'] == '1'){
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok-lt/31.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
// thêm nón
if(mysql_result($avatar,0,'non')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/non-ok-lt/'.mysql_result($avatar,0,'non').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/non-ok-lt/load/'.mysql_result($avatar,0,'non').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/non-ok-lt/load/'.mysql_result($avatar,0,'non').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
// thêm mặt nạ
if(mysql_result($avatar,0,'matna')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok-lt/'.mysql_result($avatar,0,'matna').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/matna-ok-lt/load/'.mysql_result($avatar,0,'matna').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/matna-ok-lt/load/'.mysql_result($avatar,0,'matna').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/cancau-ok-lt/'.mysql_result($avatar,0,'cancau').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/cancau-ok-lt/'.mysql_result($avatar,0,'cancau').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/cancau-ok-lt/'.mysql_result($avatar,0,'cancau').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
if($avatar2['zombie'] == '1'){
$canh=ImageWorkshop::initFromPath($rootpath.'images/ao-ok-lt/88.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
if($avatar2['zombie'] == '1'){
$canh=ImageWorkshop::initFromPath($rootpath.'images/quan-ok-lt/86.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 0, "LT");
}
// thêm phụ kiện
if(mysql_result($avatar,0,'docamtay')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok-lt/'.mysql_result($avatar,0,'docamtay').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/docamtay-ok-lt/load/'.mysql_result($avatar,0,'docamtay').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok-lt/load/'.mysql_result($avatar,0,'docamtay').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/thucung-ok-lt/'.mysql_result($avatar,0,'thucung').'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/thucung-ok-lt/load/'.mysql_result($avatar,0,'thucung').'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/thucung-ok-lt/load/'.mysql_result($avatar,0,'thucung').'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
/*
if ($avatar2['kichhoat']==0) {

$canh=ImageWorkshop::initFromPath($rootpath.'images/docamtay-ok-lt/214.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh, 0, 1, "LT");
}
*/
