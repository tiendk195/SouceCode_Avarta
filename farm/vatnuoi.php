...
/*
echo '&laquo; <a href="vatnuoi.php"><b>Quay lại</b></a>'; 
if(isset($_GET['id']))echo '</br>&raquo; <a href="index.php"><b>Nông trại</b></a> &raquo; <a href="/farm"><b>Trang trại</b></a>';
*/
echo "</div>";
echo'</div>';
...
if ($datauser['luong'] < $post['sotien']) {
echo'<div class="menu list-top"><b style="color:red">Bạn không đủ lượng để mua '.htmlspecialchars($post['tenvatnuoi']).' nhé !</b></div>';
echo "<div class='menu list-top congdong'>";
/*
echo '&laquo; <a href="vatnuoi.php"><b>Quay lại</b></a>'; 
if(isset($_GET['id']))echo '</br>&raquo; <a href="index.php"><b>Nông trại</b></a> &raquo; <a href="/farm"><b>Trang trại</b></a>';
...
if ($post[loaixu] == 'luong' && $datauser['luong'] > $post['sotien']) {
mysql_query("UPDATE users SET `luong` = `luong`-'{$post[sotien]}' WHERE `id` = '{$user_id}'");
}
...
if(isset($_GET['id']))echo "&raquo; <a href='vatnuoi.php'><b>Quay lại</b></a></br>";
echo '&raquo; <a href="/nongtrai/cuahang.php"><b>Cửa hàng</b></a> &raquo; <a href="index.php"><b>Nông trại</b></a> &raquo; <a href="/farm"><b>Trang trại</b></a>';
echo "</div></div>";
}else{
