...
$semen = mysql_fetch_array(mysql_query("select * from `fermer_name` WHERE  `id` = '19'  LIMIT 1")); 
$remils = mysql_result(mysql_query("SELECT COUNT(*) FROM `fermer_sclad` WHERE `id_user` = '$user_id' AND `semen` = '19'"),0);
if($remils>0) {
mysql_query("UPDATE `fermer_sclad` SET `kol` = `kol`+ '".$sotrung[soluong]."' WHERE `id_user` = $user_id AND `semen` = '19' LIMIT 1");
} else {
mysql_query("INSERT INTO `fermer_sclad` (`kol` , `semen`, `id_user`) VALUES  ('".$sotrung[soluong]."', '19', '".$user_id."') ");
}
...
$semen = mysql_fetch_array(mysql_query("select * from `fermer_name` WHERE  `id` = '20'  LIMIT 1")); 
$remils = mysql_result(mysql_query("SELECT COUNT(*) FROM `fermer_sclad` WHERE `id_user` = '$user_id' AND `semen` = '20'"),0);
if($remils>0) {
mysql_query("UPDATE `fermer_sclad` SET `kol` = `kol`+ '".$sosua[soluong]."' WHERE `id_user` = $user_id AND `semen` = '20' LIMIT 1");
} else {
mysql_query("INSERT INTO `fermer_sclad` (`kol` , `semen`, `id_user`) VALUES  ('".$sosua[soluong]."', '20', '".$user_id."') ");
}
...
$semen = mysql_fetch_array(mysql_query("select * from `fermer_name` WHERE  `id` = '21'  LIMIT 1")); 
$remils = mysql_result(mysql_query("SELECT COUNT(*) FROM `fermer_sclad` WHERE `id_user` = '$user_id' AND `semen` = '21'"),0);
if($remils>0) {
mysql_query("UPDATE `fermer_sclad` SET `kol` = `kol`+ '".$longcuu[soluong]."' WHERE `id_user` = $user_id AND `semen` = '21' LIMIT 1");
} else {
mysql_query("INSERT INTO `fermer_sclad` (`kol` , `semen`, `id_user`) VALUES  ('".$longcuu[soluong]."', '21', '".$user_id."') ");
}
