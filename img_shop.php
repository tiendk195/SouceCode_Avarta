...
//Nền sau
if ($loai==nensau) {
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai.'-ok-lt/'.$id.'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai.'-ok-lt/load/'.$id.'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai.'-ok-lt/load/'.$id.'.png');
...
else if ($loai !=haoquang AND $datauser['haoquang']!=0){
     $loai2='haoquang';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 0, "LT");
 }
//Cánh
...
$base2->addLayerOnTop($canh, 0, 0, "LB");
 ...
 } else if ($loai !=canh AND $datauser['canh']!=0){
     $loai2='canh';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=quan AND $datauser['quan']!=0){
     $loai2='quan';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=ao AND $datauser['ao']!=0){
     $loai2='ao';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=khuonmat AND $datauser['khuonmat']!=0){
     $loai2='khuonmat';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=toc AND $datauser['toc']!=0){
     $loai2='toc';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=cancau AND $datauser['cancau']!=0){
     $loai2='cancau';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
} else if ($loai !=docamtay AND $datauser['docamtay']!=0){
     $loai2='docamtay';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai.'-ok-lt/'.$id.'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai.'-ok-lt/load/0.png')){
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai.'-ok-lt/load/0.png');
$base2->addLayerOnTop($canh, 0, 0, "LB");
} else $base2->addLayerOnTop($canh, 0, 1, "LT");
}
else if ($loai !=mat AND $datauser['mat']!=0){
     $loai2='mat';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
$canh2=ImageWorkshop::initFromPath($rootpath.'images/mat-ok-lt/load/0.png');

$base->addLayerOnTop($canh, 0, 0, "LB");
$base2->addLayerOnTop($canh2, 0, 1, "LT");
}
...
} else if ($loai !=matna AND $datauser['matna']!=0){
     $loai2='matna';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
} else if ($loai !=kinh AND $datauser['kinh']!=0){
     $loai2='kinh';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
} else if ($loai !=non AND $datauser['non']!=0){
     $loai2='non';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
...
else if ($loai !=thucung AND $datauser['thucung']!=0){
     $loai2='thucung';
$canh=ImageWorkshop::initFromPath($rootpath.'images/'.$loai2.'-ok-lt/'.$datauser[''.$loai2.''].'.png');
$base->addLayerOnTop($canh, 0, 0, "LB");
if(file_exists($rootpath.'images/'.$loai2.'-ok-lt/load/'.$datauser[''.$loai2.''].'.png')){
