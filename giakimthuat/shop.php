...
echo'<div class="nenvip"> Giả kim thuật > Hoàng tử ba tư > Cửa hàng</div>';
...
<br><img src="https://i.imgur.com/b7v6xnq.gif"></center></td><td width="80%"><div class="pmenu"><div style="overflow: auto;height:140px">';

$vatpham=mysql_query("SELECT * FROM `giakimthuat_shopbatu`  ORDER BY `id`");
