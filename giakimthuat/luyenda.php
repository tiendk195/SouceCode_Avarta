...
echo'<div class="nenvip"> Giả kim thuật > Hoàng tử ba tư > Luyện đá</div>';
switch($act) {
default:
...
<font size="1" color="white" style="text-shadow: 0 0 0.2em #9932CC, 0 0 0.2em #9932CC,  0 0 0.2em #9932CC"><b>Chào mừng ngươi đến với chức năng Luyện đá</b></font></div>
<br><img src="https://i.imgur.com/b7v6xnq.gif"></center></td><td width="80%"><div class="pmenu"><div style="overflow: auto;height:100px">';

$vatpham=mysql_query("SELECT * FROM `giakimthuat_shopbatu_luyenda`  ORDER BY `id`");
...
echo' </div></div></td></tr></tbody></table><div id="hien"></div><div id="luyen"></div></div>';


break;
case 'index':
    echo'<div class="traloi"><img src="/images/next.png"><a href="luyenda.php"> Luyện đá </a></div>';
    echo'<div class="traloi"><img src="/images/next.png"><a href="nangcap.php"> Nâng cấp vật phẩm </a></div>';
    echo'<div class="traloi"><img src="/images/next.png"><a href="index.php"> Quay về </a></div>';
}
